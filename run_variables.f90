...
!FSL definimos imp_wat aqui
  LOGICAL :: imp_wat, fix_stp
  REAL(DP) :: stp_val

!FSL definicao dos parametros de E_hyd e Eqqcor
  INTEGER :: ah1, ah2
  REAL(DP) :: Hh1, Hh2, Hh3, sh1, sh2, sh3, rh1, rh2, rh3, rme1, rme2, rme3
  REAL(DP) :: epsscale, sigscale

!FSL definicao de interacao de cauda-cabeca polar aqui
  LOGICAL :: surfsim
  REAL(DP) :: erep, hescale
  INTEGER, DIMENSION(2) :: head = (/12,13/)
  INTEGER, DIMENSION(8) :: tail = (/1,2,3,4,5,6,7,8/)

!FSL definicao do peso estatistico pra pegar surf ou contraion
  REAL(DP) :: idw_surf
!FSL definicao de broglie pair
  REAL(DP) :: dbpair
